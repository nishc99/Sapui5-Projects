		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "block model page",
									"targetURL": "#comexampleblockmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleblockmodel-display": {
								"semanticObject": "comexampleblockmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.blockmodel",
									"url": sap.ui.require.toUrl("com/example/blockmodel")
								}
							}
						}
					}
