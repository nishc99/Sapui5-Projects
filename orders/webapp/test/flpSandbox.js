		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "order page",
									"targetURL": "#comexampleorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleorders-display": {
								"semanticObject": "comexampleorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.orders",
									"url": sap.ui.require.toUrl("com/example/orders")
								}
							}
						}
					}
