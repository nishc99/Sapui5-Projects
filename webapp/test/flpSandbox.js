		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo project",
									"targetURL": "#comexampleproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleproject-display": {
								"semanticObject": "comexampleproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.project",
									"url": sap.ui.require.toUrl("com/example/project")
								}
							}
						}
					}
