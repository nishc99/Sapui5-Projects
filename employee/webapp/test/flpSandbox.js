		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "employee page",
									"targetURL": "#comexampleemployee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleemployee-display": {
								"semanticObject": "comexampleemployee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.employee",
									"url": sap.ui.require.toUrl("com/example/employee")
								}
							}
						}
					}
