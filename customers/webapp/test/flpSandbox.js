		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "customer page",
									"targetURL": "#comexamcustomers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamcustomers-display": {
								"semanticObject": "comexamcustomers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.exam.customers",
									"url": sap.ui.require.toUrl("com/exam/customers")
								}
							}
						}
					}
