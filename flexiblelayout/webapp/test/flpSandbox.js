		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flexiblelayout Page",
									"targetURL": "#comexampleflexiblelayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleflexiblelayout-display": {
								"semanticObject": "comexampleflexiblelayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.flexiblelayout",
									"url": sap.ui.require.toUrl("com/example/flexiblelayout")
								}
							}
						}
					}
