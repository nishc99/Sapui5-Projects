...
sap.ui.define(["sap/ui/base/Object"], function (UI5Object) {
	...
	var sMockdataPath = jQuery.sap.getModulePath("com.example.flexiblelayout") + "/model/api/mockdata/";
	...
	return UI5Object.extend("com.example.flexiblelayout.model.api.provider.MockProvider", {
		_iDelay: 1000,
		_oData: {},
				...
				function (resolve, reject) {
					this._onDataReady().then(
						function () { 
							debugger;
								// STANDARD EXECUTION
								this._oData.notifications = this._oData.notifications.find(
