sap.ui.define([
  ...
  "sap/ui/core/Fragment"
     ...
     */
    function (Controller, History, MessageBox, Message, library, Fragment) {
        "use strict";
  
        return Controller.extend("com.example.flexiblelayout.controller.Base", {
      ...
      setVisibility: function (sControl, bVisible) {
        this._oAppModel.setProperty("/VISIBILITY/" + sControl, bVisible);
            ...
            getRootModulePath: function () {
                return jQuery.sap.getModulePath("com.example.flexiblelayout");
            },           
