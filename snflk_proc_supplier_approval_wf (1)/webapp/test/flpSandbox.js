		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsnflkprocsnflkprocsupplierapprovalwf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsnflkprocsnflkprocsupplierapprovalwf-display": {
								"semanticObject": "comsnflkprocsnflkprocsupplierapprovalwf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.snflk.proc.snflkprocsupplierapprovalwf",
									"url": sap.ui.require.toUrl("com/snflk/proc/snflkprocsupplierapprovalwf")
								}
							}
						}
					}
