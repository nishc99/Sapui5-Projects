...
sap.ui.define(["sap/ui/base/Object"], function (UI5Object) {
	...
	var sMockdataPath = jQuery.sap.getModulePath("com.snflk.proc.snflkprocsupplierapprovalwf") + "/model/api/mockdata/";
	...
	return UI5Object.extend("com.snflk.proc.snflkprocsupplierapprovalwf.model.api.provider.MockProvider", {
		_iDelay: 1000,
		_oData: {},
			...
			var oPromise = new Promise(
				function (resolve, reject) {
					this._onDataReady().then(
						function () { debugger;
								// STANDARD EXECUTION
								this._oData.Requests = this._oData.Requests.filter(
									function (oRequestListItem){
										return (
											oRequestListItem
										);
									});
								resolve(this._oData.Requests);							
						}.bind(this)
					);
				}.bind(this)
			);
