		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind page",
									"targetURL": "#comexamplenorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplenorthwind-display": {
								"semanticObject": "comexamplenorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.northwind",
									"url": sap.ui.require.toUrl("com/example/northwind")
								}
							}
						}
					}
