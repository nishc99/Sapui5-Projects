sap.ui.define([
    ...
    return BaseController.extend("com.example.shipper.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                ShipperID: function(oContext) {
                    var iNumber = oContext.getProperty('ShipperID'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("ShipperID", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.example.shipper.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1" :
                        aFilters.push(new Filter("ShipperID", FilterOperator.LE, 100));
                        break;
                    case "Filter2" :
                        aFilters.push(new Filter("ShipperID", FilterOperator.GT, 100));
                        break;
                    default :
                        break;
                }
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("ShipperID")
            }, bReplace);
        },
