		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "shipper page",
									"targetURL": "#comexampleshipper-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleshipper-display": {
								"semanticObject": "comexampleshipper",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.shipper",
									"url": sap.ui.require.toUrl("com/example/shipper")
								}
							}
						}
					}
