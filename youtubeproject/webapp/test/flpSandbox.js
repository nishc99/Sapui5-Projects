		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comexampleyoutubeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleyoutubeproject-display": {
								"semanticObject": "comexampleyoutubeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.youtubeproject",
									"url": sap.ui.require.toUrl("com/example/youtubeproject")
								}
							}
						}
					}
