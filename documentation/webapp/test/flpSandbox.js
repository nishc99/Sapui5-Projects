		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample Page",
									"targetURL": "#comexampledocumentation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampledocumentation-display": {
								"semanticObject": "comexampledocumentation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.documentation",
									"url": sap.ui.require.toUrl("com/example/documentation")
								}
							}
						}
					}
