		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "manageallocations",
									"targetURL": "#comexamplemanageallocations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplemanageallocations-display": {
								"semanticObject": "comexamplemanageallocations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.manageallocations",
									"url": sap.ui.require.toUrl("com/example/manageallocations")
								}
							}
						}
					}
